 ...
 * @since 1.0
 */
namespace mailwizz\Http;

use mailwizz\MailWizzApiBase;
use mailwizz\Http\Client;
use mailwizz\Params;
use mailwizz\Json as MailWizzApi_Json;
use mailwizz\Params as MailWizzApi_Params;
use mailwizz\Http\Response as MailWizzApi_Http_Response;

class Request extends MailWizzApiBase
{
    /**
